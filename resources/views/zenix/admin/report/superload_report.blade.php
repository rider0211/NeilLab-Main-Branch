        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <?php
                        if($trade_type == 1){ ?>
					<a href="{!! url('/admin/masterload_report_buy/'.$masterload_id); !!}" class="btn btn-secondary mb-2">Back</a>
                    <?php }else{ ?>
                    <a href="{!! url('/admin/masterload_report_sell/'.$masterload_id); !!}" class="btn btn-secondary mb-2">Back</a>
                    <?php } ?>
                </div>
                <div class="card-body">
