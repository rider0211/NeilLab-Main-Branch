                            ...
                            <tbody>
								...
								<tr>
                                    ...
                                    <td>
                                        <?php
                                            if($value->trade_type == 1){ ?>
                                        <a href="{!! url('/admin/subload_report_buy/'.$value->id); !!}">View Sub Load</a>
                                        <?php }else{ ?>
                                            <a href="{!! url('/admin/subload_report_sell/'.$value->id); !!}">View Sub Load</a>
                                        <?php } ?>
                                    </td>
                                    <td >
                                        <?php
                                            if($value->trade_type == 1){ ?>
                                        <a href="{!! url('/admin/superload_report_buy/'.$value->id); !!}">View Super Load</a>
                                        <?php }else{ ?>
                                            <a href="{!! url('/admin/superload_report_sell/'.$value->id); !!}">View Super Load</a>
                                        <?php } ?>
                                    </td>
                                </tr>
								@endforeach
